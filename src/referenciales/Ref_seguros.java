 ...
 * @author schafler92
 */
public class Ref_seguros extends javax.swing.JInternalFrame {
    ...
    public Ref_seguros() {
     ...
     if(txtBuscar.getText().trim().length()>1){
        new TblThread("SELECT seg_cod,seg_des,seg_dir,seg_tel,seg_mail FROM v_seg "+see+" AND seg_des LIKE '%"+txtBuscar.getText().trim().toUpperCase()+"%'"
                + " ORDER BY 2 ASC", jTable1,null,null,DB.con,this,new int[]{1,2,2,1,2,4}).start(); 
     }
    ...
    private void initComponents() {
        ...
        setTitle("Mantener Cias. de Seguro");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtDes, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtCod, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(txtDir, javax.swing.GroupLayout.PREFERRED_SIZE, 308, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(111, 111, 111))
        );
...
private void clean(){
  ...
  private void limpiarTabla(){
     ...
     private void validar_blancos(){      
         if(txtDes.getText().trim().isEmpty() || txtTel.getText().length()<8){
    ...
    int[] tipos_de_get = {1,1,2,2,1,2};
    String[] parametros = {String.valueOf(bandera),cod,txtDes.getText(),txtDir.getText(),txtTel.getText(),txtMail.getText()};
    isOk=DB.executeCst("abm_seg(?,?,?,?,?,?)", tipos_de_get,parametros,true);
