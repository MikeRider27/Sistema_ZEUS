 ...
 * @author schafler92
 */
public class Ref_nacionalidades extends javax.swing.JInternalFrame {
    
    private final conectarDB DB; 
    int bandera,isOk=0;
    String aop,cod,see="est_cod='VIG'";

    public Ref_nacionalidades(){
        initComponents();
          DB = new conectarDB();
          DB.btnAlign(new JButton[]{btnAdd,btnEdit,btnDelete,btnSave,btnCancelar,null},
                  jTabbedPane1,
                   cboSee,1);    
    }
   ...
   private void cargarTabla(){
     ...
     if(txtBuscar.getText().trim().length()>1){
        new TblThread("SELECT nac_cod,nac_des FROM v_nac WHERE nac_des LIKE '%"+txtBuscar.getText().trim().toUpperCase()+"%' AND "+see
    ...
    private void initComponents() {
        ...
        setTitle("Mantener Nacionalidades");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(txtDes, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
...
private void clean(){
  ...
  private void limpiarTabla(){
    ...
    isOk=DB.executeCst("abm_nac(?,?,?)", tipos_de_get,parametros,true);
