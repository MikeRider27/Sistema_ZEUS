 ...
 * @author schafler92
 */
public class Ref_ciudad extends javax.swing.JInternalFrame {
    ...
    public Ref_ciudad() {
       ...
       if(txtBuscar.getText().trim().length()>1){
        new TblThread("SELECT ciu_cod,ciu_des FROM v_ciu WHERE ciu_des LIKE '%"+txtBuscar.getText().trim().toUpperCase()+"%' AND "+see
...
private void clean(){
  ...
  private void limpiarTabla(){
    ...
    isOk=DB.executeCst("abm_ciu(?,?,?)", tipos_de_get,parametros,true);
