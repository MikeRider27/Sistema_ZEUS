 ...
 * @author schafler92
 */
public class Ref_cargos extends javax.swing.JInternalFrame {
    ...
    public Ref_cargos() {
     ...
     if(txtBuscar.getText().trim().length()>1){
        new TblThread("SELECT car_cod,car_des FROM v_car WHERE car_des LIKE '%"+txtBuscar.getText().trim().toUpperCase()+"%' AND "+see
                + " ORDER BY car_des ASC", jTable1,null,null,DB.con,this,new int[]{1,2}).start(); 
     }
 }   
    ...
    private void initComponents() {
        ...
        chkUsr = new javax.swing.JCheckBox();
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cboSee, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
if(evt.getKeyCode() == 10){
    ...
    private javax.swing.JCheckBox chkUsr;
...
//    txtPass.setText("");
  ...
  private void limpiarTabla(){
     ...
     private void save(){
    int[] tipos_de_get = {1,1,2,4};
    String[] parametros = {String.valueOf(bandera),cod,txtDes.getText(),String.valueOf(chkUsr.isSelected())};
    isOk=DB.executeCst("abm_car(?,?,?,?)", tipos_de_get,parametros,true);
