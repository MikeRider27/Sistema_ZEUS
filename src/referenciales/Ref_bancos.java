 ...
 * @author schafler92
 */
public class Ref_bancos extends javax.swing.JInternalFrame {
    ...
    public Ref_bancos() {
        ...
        private void cargarTabla(){
            limpiarTabla();
        new TblThread("SELECT ban_cod,ban_des FROM v_ban WHERE "+see+" "
    ...
    private void initComponents() {
        ...
        setTitle("Mantener Entidades Bancarias");
...
private void clean(){
  ...
  private void limpiarTabla(){
    ...
    isOk=DB.executeCst("abm_ban(?,?,?)", tipos_de_get,parametros,true);
