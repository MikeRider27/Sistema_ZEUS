 ...
 * @author schafler92
 */
public class Ref_motivo_ajuste extends javax.swing.JInternalFrame {
    
    private final conectarDB DB;
    int bandera,isOk=0;
    String aop,cod,see="est_cod='VIG'";

    public Ref_motivo_ajuste() {
        initComponents();
          DB = new conectarDB();
          ManageButtons(1);   
    }
...
if(txtBuscar.getText().trim().length()>1){
        new TblThread("SELECT mot_cod,tmot_des,mot_des FROM v_mot WHERE mot_des LIKE '%"+txtBuscar.getText().trim().toUpperCase()+"%' AND "+see
                + "ORDER BY 2 ASC", jTable1,null,null,DB.con,this,new int[]{1,2,2}).start();  
}         
}   
    ...
    private void initComponents() {
        ...
        cboTmot = new javax.swing.JComboBox();
        ...
        setTitle("Mantener Motivo de Ajuste");
        ...
        jLabel3.setText("Tipo de Motivo");

        cboTmot.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Elegir", "NEGATIVO", "POSITIVO" }));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(cboTmot, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel13))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(txtDes, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cboTmot, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel13)
                    .addComponent(jLabel3))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Tipo de Motivo", "Descripcion"
            }
        ) {
...
if(bandera==2)txtDes.selectAll();
    ...
    private javax.swing.JComboBox cboTmot;
...
private void al_agregar(){
    bandera=1;
    ManageButtons(3);
cod=DB.getDBcod("mot_cod","v_mot");
txtCod.setText(cod);
cboTmot.requestFocus();
}
...
isOk=0;
  ...
  private void limpiarTabla(){
     ...
     private void validar_blancos(){
         if(txtDes.getText().trim().isEmpty() || cboTmot.getSelectedIndex()==0){
    ...
    int[] tipos_de_get = {1,1,2,1};
    Object[] parametros = {bandera,cod,txtDes.getText().trim(),cboTmot.getSelectedIndex()};
    isOk=DB.executeCst("abm_mot(?,?,?,?)", tipos_de_get,parametros,true);
    if(isOk==0)DB.EmitirMensaje(this, bandera);
     }
     
     private void cargarDatos(){
           txtDes.setText(jTable1.getValueAt(jTable1.getSelectedRow(),2).toString());
           cboTmot.setSelectedItem(jTable1.getValueAt(jTable1.getSelectedRow(),1).toString());
       }
     
     private void ManageClosing(){
       dispose();
       DB.shutdown();
       Menu.menMot.setEnabled(true);
     }
}