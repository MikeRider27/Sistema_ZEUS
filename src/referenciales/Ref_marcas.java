 ...
 * @author schafler92
 */
public class Ref_marcas extends javax.swing.JInternalFrame {
...
if(txtBuscar.getText().trim().length()>1){
        new TblThread("SELECT mar_cod,mar_des FROM v_mar WHERE mar_des LIKE '%"+txtBuscar.getText().trim().toUpperCase()+"%' AND "+see
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cboSee, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
isOk=0;
  ...
  private void limpiarTabla(){
    ...
    isOk=DB.executeCst("abm_mar(?,?,?)", tipos_de_get,parametros,true);
