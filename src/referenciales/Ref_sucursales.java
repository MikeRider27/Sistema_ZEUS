 ...
 * @author schafler92
 */
public class Ref_sucursales extends javax.swing.JInternalFrame {
    
    private final conectarDB DB;
    int bandera,isOk=0;
    String aop,cod,see=" WHERE est_cod='VIG'",buscar="suc_des LIKE";

    public Ref_sucursales() {
        initComponents();
          DB = new conectarDB();
          ManageButtons(1);
    }
  ...
  private void cargarTabla(){
     limpiarTabla();
        ...
        new TblThread("SELECT suc_cod,suc_des,suc_dir,suc_tel,suc_mail FROM v_suc "+see+" AND "+buscar+" '%"+txtBuscar.getText().trim().toUpperCase()+"%'"
                + " ORDER BY suc_des ASC", jTable1,null,null,DB.con,this,new int[]{1,2,2,1,2,4}).start(); 
     }
 }   
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(txtCod, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                        .addComponent(txtTel, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel19))
                    .addComponent(txtMail, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtDir, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 296, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Descripcion", "Direccion", "Telefono", "Mail"
            }
        ) {
...
private void clean(){
  ...
  private void limpiarTabla(){
     ...
     private void validar_blancos(){      
         if(txtDes.getText().trim().isEmpty() || txtTel.getText().length()<8 || txtDir.getText().trim().isEmpty()){
    ...
    int[] tipos_de_get = {1,1,2,1,2,2};
    String[] parametros = {String.valueOf(bandera),cod,txtDes.getText(),txtTel.getText(),txtDir.getText(),txtMail.getText()};
    isOk=DB.executeCst("abm_suc(?,?,?,?,?,?)", tipos_de_get,parametros,true);
