 ...
 * @author schafler92
 */
public class Ref_colores extends javax.swing.JInternalFrame {
    ...
    public Ref_colores() {
       ...
       if(txtBuscar.getText().trim().length()>1){
        new TblThread("SELECT col_cod,col_des FROM v_col WHERE col_des LIKE '%"+txtBuscar.getText().trim().toUpperCase()+"%' AND "+see
                + " ORDER BY col_des ASC", jTable1,null,null,DB.con,this,new int[]{1,2}).start();  
} 
 }       
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cboSee, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
save();
    ...
    isOk=DB.executeCst("abm_col(?,?,?)", tipos_de_get,parametros,true);
