 ...
 * @author schafler92
 */
public class Ref_motivo_garantia extends javax.swing.JInternalFrame {
    
    private final conectarDB DB;
    int bandera,isOk=0;
    String aop,cod,see="est_cod='VIG'";

    public Ref_motivo_garantia() {
        initComponents();
          DB = new conectarDB();
          ManageButtons(1);   
    }
...
if(txtBuscar.getText().trim().length()>1){
        new TblThread("SELECT mot_cod,mot_des FROM v_motg WHERE mot_des LIKE '%"+txtBuscar.getText().trim().toUpperCase()+"%' AND "+see
    ...
    private void initComponents() {
        ...
        setTitle("Mantener Motivo de Garantia");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cboSee, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
private void al_agregar(){
    bandera=1;
    ManageButtons(3);
cod=DB.getDBcod("mot_cod","v_motg");
txtCod.setText(cod);
txtDes.requestFocus();
}
...
isOk=0;
  ...
  private void limpiarTabla(){
    ...
    isOk=DB.executeCst("abm_motg(?,?,?)", tipos_de_get,parametros,true);
