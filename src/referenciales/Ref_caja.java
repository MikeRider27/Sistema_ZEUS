 ...
 * @author schafler92
 */
public class Ref_caja extends javax.swing.JInternalFrame {
   ...
   private void cargarTabla(){
     ...
     if(txtBuscar.getText().trim().length()>1){
        new TblThread("SELECT caj_cod,caj_des FROM v_caj WHERE caj_des LIKE '%"+txtBuscar.getText().trim().toUpperCase()+"%'"
...
private void clean(){
  ...
  private void limpiarTabla(){
    ...
    isOk=DB.executeCst("abm_caj(?,?,?)", tipos_de_get,parametros,true);
